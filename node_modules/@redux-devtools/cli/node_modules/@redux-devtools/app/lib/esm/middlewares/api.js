...
import { UPDATE_STATE, REMOVE_INSTANCE, LIFTED_ACTION, UPDATE_REPORTS, GET_REPORT_REQUEST, GET_REPORT_ERROR, GET_REPORT_SUCCESS } from '../constants/actionTypes';
...
function subscribe(channelName, subscription) {
  ...
  if (subscription === UPDATE_STATE) channel.watch(monitoring);else {
