...
export declare const effects: {
    color: (color: string, effect: "alpha" | "lighten" | "fade", val: number) => string;
};
export { default as createStyledComponent } from './utils/createStyledComponent';
export { listSchemes, listThemes, type ThemeName, type ThemeFromProvider, type SchemeName, } from './utils/theme';
