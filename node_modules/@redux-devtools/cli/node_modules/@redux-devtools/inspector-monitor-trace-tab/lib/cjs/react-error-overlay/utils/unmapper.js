          ...
          case 9:
            ...
            return _context.abrupt("return", frames.map(function (frame) {
              ...
              if (fileName) {
                ...
                fileName = _pathBrowserify.default.normalize(fileName.replace(/[\\]+/g, '/'));
              }
              ...
              .map(function (s) {
                ...
                p = _pathBrowserify.default.normalize(p);
                var i = p.lastIndexOf(fN);
                return i !== -1 && i === p.length - fN.length;
              }).map(function (p) {
                return {
                  token: p,
                  seps: count(_pathBrowserify.default.sep, _pathBrowserify.default.normalize(p)),
