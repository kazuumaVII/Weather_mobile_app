...
exports.createStylingFromTheme = exports.colorMap = exports.StyleUtilsContext = void 0;
exports.createThemeState = createThemeState;
...
var reduxThemes = _interopRequireWildcard(require("redux-devtools-themes"));
...
var getSheetFromColorMap = function getSheetFromColorMap(map) {
  ...
  return {
    ...
    closeButton: _objectSpread(_objectSpread({}, appearanceNone), {}, {
      border: 'none',
      outline: 'none',
      boxShadow: 'none',
      display: 'block',
...
var getDefaultThemeStyling = function getDefaultThemeStyling(theme) {
  ...
  themeSheet = _jss.default.createStyleSheet(getSheetFromColorMap(colorMap(theme))).attach();
  return themeSheet.classes;
};

var createStylingFromTheme = (0, _reactBase16Styling.createStyling)(getDefaultThemeStyling, {
  defaultBase16: reduxThemes.nicinabox,
  base16Themes: _objectSpread({}, reduxThemes)
});
exports.createStylingFromTheme = createStylingFromTheme;

function createThemeState(props) {
  var _getBase16Theme;

  var base16Theme = (_getBase16Theme = (0, _reactBase16Styling.getBase16Theme)(props.theme, _objectSpread({}, reduxThemes))) !== null && _getBase16Theme !== void 0 ? _getBase16Theme : reduxThemes.nicinabox;
...
var mockStyling = function mockStyling() {
  return {
    className: '',
    style: {}
  };
...
var StyleUtilsContext = /*#__PURE__*/(0, _react.createContext)({
  base16Theme: reduxThemes.nicinabox,
  invertTheme: false,
  styling: mockStyling
});
exports.StyleUtilsContext = StyleUtilsContext;
