...
exports.createStylingFromTheme = exports.base16Themes = void 0;
...
var _inspector = _interopRequireDefault(require("../themes/inspector"));

var reduxThemes = _interopRequireWildcard(require("redux-devtools-themes"));

var inspectorThemes = _interopRequireWildcard(require("../themes"));
...
var getSheetFromColorMap = function getSheetFromColorMap(map) {
  return {
    ...
    rightSlider: {
      ...
      // http://stackoverflow.com/a/21136111/4218591
      position: 'absolute',
      right: 0,
...
var base16Themes = _objectSpread(_objectSpread({}, reduxThemes), inspectorThemes);

exports.base16Themes = base16Themes;
var createStylingFromTheme = (0, _reactBase16Styling.createStyling)(getDefaultThemeStyling, {
  defaultBase16: _inspector.default,
